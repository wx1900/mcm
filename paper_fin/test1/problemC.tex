...
% 引用文献说明
According to %TODO:(From Energy and Population. Joel Darmstadter, 2004),
...
A linear regression model that contains more than one predictor variable is called a multiple linear regression model %TODO:(http://reliawiki.org/index.php/Multiple_Linear_Regression_Analysis).
...
In data preprocessing, We uniform the data by using $Standard score$ %TODO:(https://en.wikipedia.org/wiki/Normalization_(statistics))
...
before considering a new generation. %TODO:insert an ref
...
\begin{itemize}
  ...
  \item Energy intensity
        ...
        Low energy intensity indicates a lower price or cost of converting energy into GDP.(%TODO:wiki https://en.wikipedia.org/wiki/Energy_intensity)
        $$ EI = \frac{TETCB}{GDP} $$
\end{itemize}
